...
class Spider(Spider):
  ...
  def init(self, extend="{}"):
    ...
    # 2. 备用域名列表
    self.dynamic_urls = [
            "https://zh.stripol.com",#官方防封短域名
        'https://zh.stripchat.org',#官方保留域名
        "https://zh.stripchat.global",#全球防护/备用节点
        "https://zh.stripchat.com",#主站，最推荐使用
        "https://zh.pikpedcams.com",#分销站点
        "https://zh.virtualtaboo.live",#分销站点
    ]
  ...
  def get_danmaku_desc(self, room_id):
    ...
    msg = []
    # 直接遍历 cacheMsg（不再使用 reversed），最新收到的弹幕会显示在最上方
